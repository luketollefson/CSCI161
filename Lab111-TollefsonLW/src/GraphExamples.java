...
public class GraphExamples {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(Table.adjacencyMatrixTable("Figure 14.3", figure14_3()));

    System.out.println("Figure 14.8");
    System.out.println(figure14_8());
    System.out.println(Table.adjacencyMatrixTable("Figure 14.8", figure14_8()));

    System.out.println("Figure 14.9");
    System.out.println(figure14_9());
    System.out.println(Table.adjacencyMatrixTable("Figure 14.9", figure14_9()));
    
    System.out.println("Figure 14.11");
    System.out.println(figure14_11());
    System.out.println(Table.adjacencyMatrixTable("Figure 14.11", figure14_11()));

    System.out.println("Figure 14.12");
    System.out.println(figure14_12());
    System.out.println(Table.adjacencyMatrixTable("Figure 14.12", figure14_12()));

    System.out.println("Figure 14.14");
    System.out.println(figure14_14());
    System.out.println(Table.adjacencyMatrixTable("Figure 14.14", figure14_14()));

    System.out.println("Figure 14.15");
    System.out.println(figure14_15());
    System.out.println(Table.adjacencyMatrixTable("Figure 14.15", figure14_15()));
